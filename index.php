...
<html>
	<head>
        ...
        <title>On Target Brand Merchandise </title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://www.mobilegrows.com" rel="external">MobileGrows</a> | <a href="http://otbrandmerchandise.com/" rel="external">Desktop Site</a></h1>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b" id="findUS">
                      ...
                      <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                         <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Home</a>
                            ...
                            <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                                <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Screen printing & Embroidery</a>
                                </div>
                            </div>
                            <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                                <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Importing</a>
                                </div>
                            </div>
						</div>						
            ...
            <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Search for Products</a>
                </div>
            </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		...
		<div data-role="page" id="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu" class="naziv">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Home</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Screen printing & Embroidery</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Importing</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">About Us</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Search for Products</a></li>
